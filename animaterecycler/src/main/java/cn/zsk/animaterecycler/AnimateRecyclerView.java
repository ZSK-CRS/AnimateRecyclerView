...
import static cn.zsk.animaterecycler.BaseRefreshHeader.STATE_DONE;
...
public class AnimateRecyclerView extends RecyclerView {
    ...
    //判断是否是AnimateRecyclerView保留的itemViewType
        ...
        public void onChanged() {
            ...
            if (mWrapAdapter != null && mEmptyView != null) {
                ...
                if (mWrapAdapter.getItemCount() == emptyCount) {
                    ...
                    AnimateRecyclerView.this.setVisibility(View.GONE);
                } else {
                    mEmptyView.setVisibility(View.GONE);
                    AnimateRecyclerView.this.setVisibility(View.VISIBLE);
                }
            }
        }
            ...
            if (adapter != null) {
                ...
                if (adjPosition < adapterCount) {
                    ...
                    if(isReservedItemViewType(type)) {
                        throw new IllegalStateException("AnimateRecyclerView require itemViewType in adapter should be less than 10000 " );
                    }
                    return type;
                }
            }
